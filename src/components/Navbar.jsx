  ...
  return (
    <nav className="cursor-pointer">
      <div className="flex justify-between items-center h-16 px-4 md:px-8 text-gray-600 bg-[#F9E0DB]">
        <div className="flex items-start text-center gap-1 flex-col lg:flex-row border-none lg:border border-black p-1">
        ...
        <div className="hidden lg:flex gap-4 border border-black p-1 font-mono">
